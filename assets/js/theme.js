(function ($) {
    ...
    $(document).on('click','#protect',function(){
        $('#tab-2').find('#protect-data').html('');
        let text;
        let password = prompt("Please enter password:", "");
        if (password == null || password == "") {
            $('#tab-2').find('#protect-data').html('<div class="alert alert-warning my-5">Please enter password</div>');
        } else {
            $.ajax({
              type : 'GET',
              ...
              success : function(data){
                $('#tab-2').find('#protect-data').html(data);
              },
