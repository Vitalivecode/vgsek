					...
					<table class="table" bgcolor="#ffffff" style="width:100%">
						<tr bgcolor="#ED3733">
							<td align="center" class="logo" style="border-bottom:4px solid #333333;padding:7px 0">
								<a title="<?=$site[0]->title;?>" href="<?=base_url();?>" style="color:#fff; text-decoration:none;"><h2 style="margin-top: 13px;">Invoice</h2></a></td>
						</tr>

<tr>
	<td align="center" class="titleblock" style="padding:7px 0">
		<font size="2" face="Open-sans, sans-serif" color="#555454">
			<span class="title" style="font-weight:500;font-size:28px;text-transform:uppercase;line-height:33px">Hi <?=ucfirst($client[0]->fullname);?>,</span><br/>
...
<tr>
	<td>
		<p><a href="<?=base_url().'../clients/invoice/'.$link;?>" target="_blank">Click here to view your invoice</a></p>
	</td>
</tr>
<tr>
	<td></td>
