		<div id="page-wrapper">
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            <div class="row row-in">
								...
								<p><h3>We could not remember the password, you may <a href="<?=base_url();?>">return to dashboard</a>.</h3></p>
							</div>
			...
			<div class="modal fade" id="perform" tabindex="-1" role="dialog" aria-labelledby="performLabel">
						<form name="permission_form" class="form-material form-horizontal" id="permission_form" action="<?=base_url();?>permission" method="post">
