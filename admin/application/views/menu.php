...
function createTreeView($array, $currentParent, $ct, $currLevel = 0, $prevLevel = -1 ) { 
	...
	foreach ($array as $categoryId => $category) {
		if ($currentParent == $category['parent_id']) {                       
			...
			echo '<li><a href="'.base_url().'menu/edit/'.$category['tableid'].'">'.$category['order'].'. '.$titleIcon.'</a><a href="'.base_url().'menu/delete/'.$category['tableid'].'"> <i class="fa fa-trash delete-alert"></i></a>';
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
							<div class="gps-view">
								<div class="row">
									<div class="col-md-6">
										<form method="post" class="form-material form-horizontal" id="menu_form" action="<?=base_url();?>menu">
