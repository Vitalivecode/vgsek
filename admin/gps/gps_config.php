...
{
    // default connection
    public static $dbname = 'vcpkacin_web'; // Your database name
    public static $dbuser = 'vcpkacin_web'; // Your database username
    public static $dbpass = 'vcpkacin_web'; // // Your database password
    ...
    public static $limit_list = array('50', '100', '200', 'all'); // default limits list
